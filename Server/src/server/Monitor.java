...
import firebase.FirebaseMessagingSnippets;
...
public class Monitor implements SocketListenerI {
    ...
    public void onReceiveMessage(EventReceive e) {
        ...
        /*Rule rule = getRuleByTemperature(Float.parseFloat(Serialization.temperature));
        assert rule != null;
        Mail.sendMail(rule.getMail(), rule.getMessage());*/
    }
